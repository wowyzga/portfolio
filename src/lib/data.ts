...
export const workExperience = [
  {
    company: "David Weed J, DSS · Full-time",
    location: "Mercer Island, Washington, United States · On-site",
  ...
  {
    company: "Sanford Burnham Prebys · Part-time",
  ...
  {
    company: "NCAA",
    location: "San Diego, California, United States · Full-time",
    position: "NCAA Division 1 Scholar-Athlete",
  ...
  {
    company: "University of California San Diego - Recreation",
    location: "San Diego, California, United States · Part-time",
    position: "Lifeguard",
...
export const education = [
  {
    ...
    degree: "Bachelor of Science - Human Biology",
    period: "Sep 2019 - Jun 2023",
  ...
  {
    institution: "Bellevue High School",
